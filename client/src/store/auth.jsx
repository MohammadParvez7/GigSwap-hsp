...
export const AuthProvider = ({ children }) => {
  ...
  const userAuthentication = async () => {
    try {
      ...
      const response = await fetch("https://gigswap-hsp-serverr.onrender.com/api/auth/user", {
        method: "GET",
        headers: {
  ...
  const getServices = async () => {
    try {
      const response = await fetch("https://gigswap-hsp-serverr.onrender.com/api/data/service");
      if (response.ok) {
        const data = await response.json();
